...
namespace NFUIRSL.HRTK
{
    ...
    public class ArmIntermediateLayer : IArmIntermediateLayer
    {
        ...
        public virtual int get_connection_level(int robot) => HRobot.get_connection_level(robot);

        public virtual int get_current_joint(int robot, double[] value) => HRobot.get_current_joint(robot, value);

        public virtual int get_current_position(int robot, double[] value) => HRobot.get_current_position(robot, value);

        public virtual int get_motion_state(int robot) => HRobot.get_motion_state(robot);

        public virtual int get_motor_state(int robot) => HRobot.get_motor_state(robot);
        ...
        public virtual int ptp_pos(int robot, int mode, double[] point) => HRobot.ptp_pos(robot, mode, point);

        public virtual int ptp_rel_axis(int robot, int mode, double[] point) => HRobot.ptp_rel_axis(robot, mode, point);

        public virtual int ptp_rel_pos(int robot, int mode, double[] point) => HRobot.ptp_rel_pos(robot, mode, point);

        public virtual int set_acc_dec_ratio(int robot, int v) => HRobot.set_acc_dec_ratio(robot, v);

        public virtual int set_motor_state(int robot, int onOff) => HRobot.set_motor_state(robot, onOff);

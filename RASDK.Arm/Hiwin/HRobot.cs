...
namespace RASDK.Arm.Hiwin
{
    ...
    internal class HRobot
    {
        ...
        [DllImport("HRSDK.dll")]
        public static extern int ptp_point(int robot, int mode, double[] axis, double[] pos, double[] ext);
        ...
        [DllImport("HRSDK.dll")]
        public static extern int motion_reachable(int robot, double[] dest_coord, ref bool is_reach);

        [DllImport("HRSDK.dll")]
        public static extern int motion_check_lin(int robot, double[] coord1, double[] coord2, ref bool is_reach);
        ...
        [DllImport("HRSDK.dll")]
        public static extern int mastering(int robot, string joint, string type);

        [DllImport("HRSDK.dll")]
        public static extern int calibration(int robot, string joint, string type);

        [DllImport("HRSDK.dll")]
        public static extern int download_history_zip(int robot, string dest_path);
        ...
        [DllImport("HRSDK.dll")]
        public static extern int get_alarm_log_count(int robot, ref int count);

        [DllImport("HRSDK.dll")]
        public static extern int get_alarm_log_msg(int robot, int index, UInt16[] msg);
    }
}
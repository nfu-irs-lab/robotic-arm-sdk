...
namespace RASDK.Arm.Action
{
    ...
    public class AbsoluteMotion : ArmMotion
    {
        ...
        public override bool Do()
        {
            ...
            {
                case Type.CoordinateType.Descartes when MotionType == Type.MotionType.PointToPoint:
                    returnCode = HRobot.ptp_pos(ArmId,
                                                SmoothTypeCode,
                                                Position);
                    break;

                case Type.CoordinateType.Descartes when MotionType == Type.MotionType.Linear:
                ...
                case Type.CoordinateType.Joint when MotionType == Type.MotionType.PointToPoint:
                    returnCode = HRobot.ptp_axis(ArmId,
                                                 SmoothTypeCode,
                                                 Position);
                    break;

                case Type.CoordinateType.Joint when MotionType == Type.MotionType.Linear:
